...
class AddStoryPromptViewController: UIViewController {
    ...
    @IBOutlet weak var ajectiveTextField: UITextField!
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(updateStoryPromt), name: UIResponder.keyboardDidHideNotification, object: nil)
    }
    
    @objc func updateStoryPromt() {
        
        storyPrompt.noun = nounTextField.text ?? ""
        storyPrompt.adjective = ajectiveTextField.text ?? ""
